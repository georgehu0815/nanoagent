...
- **Managed Identity Client ID**: `your-client-id-here`
...
```json
{
  ...
  "providers": {
    "azure": {
      "apiBase": "https://your-resource.cognitiveservices.azure.com/",
...
Model: azure/gpt-5.2-chat
Azure OpenAI: ✓ gpt-5.2-chat @ https://your-resource.cognitiveservices.azure.com/
...
```
✓ Model: azure/gpt-5.2-chat
✓ Azure API Base: https://your-resource.cognitiveservices.azure.com/
